#!/bin/bash
# Задание 12: изменить приоритет процессов, работающих дольше N секунд, через renice
# Использование: bash task12.sh <N_секунд> [nice_значение]
# Пример: bash task12.sh 60 10
